        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <a href="{{ route('language.create') }}" class="btn btn-primary waves-effect waves-light btn-sm rounded-pill">Create</a>
                </div>
                            ...
                            <tr style="vertical-align: middle;">
                                ...
                                <td>
                                    <div class="button-list">
                                        @if($value->status == 1)
                                        <form method="post" action="{{ route('language.inactive') }}" class="d-inline">
                                            @csrf
                                        ...
                                        @else
                                        <form method="post" action="{{ route('language.active') }}" class="d-inline">
                                            @csrf
                                            <input type="hidden" value="{{$value->id}}" name="hidden_id" />
                                        ...
                                        <a href="{{ route('language.edit',$value->id) }}" class="btn btn-xs btn-primary waves-effect waves-light"><i class="fe-edit-1"></i></a>
