            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('settings.index')}}">General Setting</a></li>
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('settings.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <!--<div class="col-sm-6 mb-3">-->
                    <!--    <div class="form-group">-->
                    <!--        <label for="dark_logo" class="form-label">Red Logo *</label>-->
                    ...
                    <!--        <input type="file" class="form-control @error('banner') is-invalid @enderror" name="banner" value="{{ old('banner') }}"  id="banner" >-->
                    <!--        <img src="{{asset($edit_data->banner)}}" class="edit-image" alt="">-->
                    <!--        @error('banner')-->
                    <!--            <span class="invalid-feedback" role="alert">-->
                    <!--                <strong>{{ $message }}</strong>-->
                    <!--            </span>-->
