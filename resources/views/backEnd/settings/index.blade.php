    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">General Setting Manage <a href="{{route('settings.create')}}" class="btn btn-info  waves-effect waves-light btn-xs">Create</a></h4>
            </div>
        </div>
    </div>       
    <!-- end page title --> 
                ...
                <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <!--<td><img src="{{asset($value->dark_logo)}}" style="height: 60px; width: auto" alt=""></td>-->
                            <td><img src="{{asset($value->favicon)}}" style="height: 60px; width: auto" alt=""></td>
                            <!--<td><img src="{{asset($value->banner)}}" style="height: 60px; width: auto" alt=""></td>-->
