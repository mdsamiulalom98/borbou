                ...
                <form action="{{route('pages.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            ...
                            <select type="text" class="select2 form-control @error('position') is-invalid @enderror" name="position"   id="position" required="">
                                <option>Select...</option>
                                <option value="1" @if($edit_data->position==1) selected @endif>Left Menu</option>
                                <option value="2" @if($edit_data->position==2) selected @endif>Right Menu</option>
                            </select>
                            @error('position')
