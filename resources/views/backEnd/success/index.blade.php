...
@section('title','Success Stories Manage')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Success Stories Manage <a href="{{route('success.create')}}" class="btn btn-info  waves-effect waves-light btn-xs">Create</a></h4>
            </div>
        </div>
    </div>       
    <!-- end page title --> 
                ...
                <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$value->title}}</td>
                            <td>{{ \Illuminate\Support\Str::limit(strip_tags($value->description), 120, $end='...') }}</td>
                            <td><img style="height: 50px; width: auto;" src="{{ asset($value->image) }}" /></td>
