        ...
        <div class="border-style-1">
            <div class="border-style-2">
                <div class="bio-heading" style="text-align:center">
                    <h1
                        style="font-family: 'nikosh', sans-serif;border-bottom:5px solid #FF0000;margin-bottom:3px;padding-bottom:3px;display:inline-block !important;font-size:32px;font-weight: normal;width:150px; margin:0 auto; color: #002A3A;">
                        জীবন বৃত্তান্ত </h1>
                </div>

                <div class="basic-info-image" style="width:100%;overflow:hidden;margin:25px 0 10px">
                    @if ($pdf_image)
                ...
                <div class="about-myself" style="overflow:hidden;margin-top:0px">
                    <div class="data-heading"
                        ...
                        <h3 style="font-size:18px;font-weight: normal;">বিস্তারিত বর্ণনাঃ</h3>
                    </div>
                ...
                <div class="basic-info" style="overflow:hidden;margin-top:0px;margin-bottom: 50px;">
                    <div class="data-heading"
                        style="background:#ffcc00;padding:10px 15px;margin:15px 0;border-radius:5px !important">
                        <h3 style="font-size:18px;font-weight: normal;">ব্যক্তিগত তথ্যঃ </h3>
                    </div>
                ...
                <div class="education-info">
                    <div class="data-heading"
                        style="background:#ffcc00;padding:10px 15px;margin:15px 0;border-radius:5px !important">
                        <h3 style="font-size:18px;font-weight: normal;">শিক্ষাগত / পেশাগত যোগ্যতাঃ</h3>
                    </div>
                ...
                <div class="education-info">
                    <div class="data-heading"
                        style="background:#ffcc00;padding:10px 15px;margin:15px 0;border-radius:5px !important">
                        <h3 style="font-size:18px;font-weight:normal;">স্থায়ী ঠিকানাঃ </h3>
                    </div>
                    <table class="table table-bordered">
                        <thead>
                ...
                <div class="education-info">
                    <div class="data-heading"
                        style="background:#ffcc00;padding:10px 15px;margin:15px 0;border-radius:5px !important">
                        <h3 style="font-size:18px;font-weight:normal;">বর্তমান ঠিকানাঃ</h3>
                    </div>
                    <table class="table table-bordered">
                        <thead>
                            <tr style="border: 1px solid #ddd; padding:5px 20px;">
