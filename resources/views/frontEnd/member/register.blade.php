            ...
            <div class="main-content">
                <div class="main-content-inner">
                    <div class="page-content">
                        <form name="myForm" action="{{ route('member_register') }}" method="POST"
                                ...
                                <div class="row light-shadow-borbou">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input id="fullName" value="{{ old('fullName') }}" name="fullName" placeholder="আপনার সম্পূর্ন নাম লিখুন"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ old('phoneNumber') }}" oninput="onlyNumbersAndConvert(this)" name="phoneNumber" type="text"
                                                class="form-control @error('phoneNumber') is-invalid @enderror" maxlength="11" placeholder="আপনার মোবাইল নাম্বার লিখুন" required />
                                            @error('phoneNumber')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group position-relative">
                                            ...
                                            <input type="password" value="{{ old('password') }}" id="passwordInput"
                                                name="password" type="text" placeholder="আপনার পাসওয়ার্ড লিখুন"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="father_name" id="father_name" placeholder="বাবার সম্পূর্ন নাম লিখুন" />
                                            @error('father_name')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="mother_name" placeholder="মায়ের সম্পূর্ন নাম লিখুন" id="mother_name" />
                                            @error('mother_name')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ old('alt_contact') }}" 
                                                ...
                                                class="form-control @error('alt_contact') is-invalid @enderror" placeholder="আপনার অন্য মোবাইল নাম্বার লিখুন"/>
                                            @error('alt_contact')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                ...
                                <div class="row atincrement educationcareer-value-inner">
                                    <div class="educationcareer-value-item col-sm-4">
                                        ...
                                        <select name="education_level" required
                                            class="education_level form-select  @error('education_level') is-invalid @enderror"
                                            id="education_level">
                                    ...
                                    <div class="educationcareer-value-item col-sm-4">
                                        ...
                                        <select name="degree_id" required class="degree_id form-select "
                                            id="degree_id">
                                            <option value="">নির্বাচন করুন</option>
                                            @foreach ($edulevels as $edulevel)
                                                <option value="{{ $edulevel->id }}">{{ $edulevel->title }}</option>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select name="working_id" id=""
                                                class="form-select @error('working_id') is-invalid @enderror "
                                                required>
                                                <option value="">নির্বাচন করুন </option>
                                    ...
                                    <div class="grid-item">
                                        <div class="form-group">
                                            ...
                                            <select name="marital_status" id=""
                                                class="no-select2 form-select @error('marital_status') is-invalid @enderror "
                                                required>
                                                <option value="">নির্বাচন করুন </option>
                                    ...
                                    <div class="grid-item">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id=""
                                                placeholder="বাচ্চার সংখ্যা উল্লেখ করুন"/>
                                            @error('children_no')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="grid-item">
                                        <div class="form-group">
                                            ...
                                            <select name="religion_id" id="religion_id"
                                                class="no-select2 form-select @error('religion_id') is-invalid @enderror"
                                                required>
                                                <option value="">নির্বাচন করুন </option>
                                    ...
                                    <div class="grid-item">
                                        <div class="form-group">
                                            ...
                                            <select required name="complexion" id="complexion"
                                                class="no-select2 form-select @error('complexion') is-invalid @enderror ">
                                                <option value=""> নির্বাচন করুন</option>
                                ...
                                <div class="shadow-padding-fixer-1 light-shadow-borbou grid-item-5">
                                    ...
                                    <div class="grid-item">
                                        <div class="form-group">
                                            ...
                                            <select name="year" id=""
                                                class=" form-select select2 @error('year') is-invalid @enderror" required>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select name="residency_id" id="residency_id"
                                                class="form-select @error('residency_id') is-invalid @enderror "
                                                required>
                                                <option value="">নির্বাচন করুন</option>
                                                @foreach ($nationalities as $nation)
                                                    <option value="{{ $nation->id }}"
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select required name="division_id" id="division_id"
                                                class="form-select @error('division_id') is-invalid @enderror  division_id">
                                                <option value="">নির্বাচন করুন </option>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select required name="district_id"
                                                class="form-select @error('district_id') is-invalid @enderror  district_id"
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select required name="upazila_id"
                                                class="form-select @error('upazila_id') is-invalid @enderror  upazila_id"
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                required name="permanent_address" placeholder="সঠিক ঠিকানা লিখুন" id="permanent_address" />
                                    ...
                                    <div class="col-sm-3 same-as-hide">
                                        <div class="form-group">
                                            ...
                                            <select required name="present_division" id="present_division"
                                                class="form-select @error('present_division') is-invalid @enderror  division_id">
                                                <option value="">নির্বাচন করুন </option>
                                                @foreach ($locations as $location)
                                                    <option value="{{ $location->id }}">{{ $location->title }}</option>
                                                @endforeach
                                    ...
                                    <div class="col-sm-3 same-as-hide">
                                        <div class="form-group">
                                            ...
                                            <select required name="present_district"
                                                class="form-select @error('present_district') is-invalid @enderror  district_id"
                                    ...
                                    <div class="col-sm-3 same-as-hide">
                                        <div class="form-group">
                                            ...
                                            <select required name="present_upazila"
                                                class="form-select @error('present_upazila') is-invalid @enderror  upazila_id"
                                    ...
                                    <div class="col-sm-3 same-as-hide">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                required name="present_address" 
                                                placeholder="সঠিক ঠিকানা লিখুন" id="present_address" />
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                           ...
                                           <textarea name="description" class="register-textarea form-control @error('description') is-invalid @enderror"
                                                id="" cols="30" maxlength="500" rows="4" placeholder="আপনার সম্পর্কে অন্যান্য সকল তথ্য এবং পছন্দের জীবনসঙ্গী সম্পর্কে বিস্তারিত লিখুন" required></textarea>
                                            @error('description')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
